...
<div class="error-container">
            ...
            <div class="error-frame">
                ...
                <div class="frame-content">
                    ...
                    <div class="director-notes">
                        ...
                        <p>Failed to complete the scene. A technical issue has occurred. Please try again, otherwise we'll have to rewrite the script.</p>
                    </div>
    ...
    <div class="spotlight left-light"></div>
    <div class="spotlight right-light"></div>
</div>
...
<style>
    ...
    .error-id, .error-take, .error-date {
    ...
    .error-message-container {
        ...
        box-shadow: 
            ...
            0 0 0 1px rgba(138, 92, 246, 0.2) inset;
        position: relative;
    }
    ...
    @media (max-width: 576px) {
        ...
        .left .perforation, .right .perforation {
            width: 10px;
            height: 8px;
        }
